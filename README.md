...
часть была видна прямо в документе. В нём подробнее описаны архитектура,
трудности, результаты и возможные улучшения.
...
scripts/        Скрипты для воспроизведения эксперимента
reports/        Готовый PDF-отчёт, графики и GIF-примеры
...
Скрипты, которые использовались только для подготовки финального PDF-отчёта и
графиков, в репозитории не оставлены: готовые материалы уже лежат в `reports/`.
