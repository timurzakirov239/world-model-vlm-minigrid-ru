...
- CLIP обучался в основном на естественных изображениях, поэтому на символических
  MiniGrid-кадрах его score получается шумным.
- Реализована компактная state-based RSSM, а не полный pixel-level Dreamer.
- Random shooting прост и нагляден, но менее эффективен, чем CEM.
